...
param(
    ...
    $DockerPath = "c:\temp\docker.exe",
#"https://aka.ms/tp4/docker",
    ...
    [string]
    [ValidateNotNullOrEmpty()]
    $ScriptPath = "c:\temp\install-containerhost.ps1",
    ...
    else  
    {
        ...
        else
        {
            ...
            try
            {
                ...
                Copy-File -SourcePath 'c:\temp\Convert-WindowsImage.ps1' -DestinationPath $convertScript
#'https://aka.ms/tp4/Convert-WindowsImage'
...
#$driveLetter = $bootVhd.Path.Substring(0,1)
#$driveLetter = "c"
#$driveLetter = ($disk | get-partition).diskpath
$driveLetter = "f"
